...
Loop எத்தனை முறை இயங்க வேண்டும் என்பது முன்கூட்டியே தெரிந்திருந்தால் For Loop பயன்படுத்துவது சிறந்தது. Arrays, Lists மற்றும் Fixed Size Data-களுடன் இது அதிகமாக பயன்படுத்தப்படுகிறது.`,
  ...
  realWorldUsage:
    "Developers use Nested Loops to work with tables, matrices, seating arrangements, attendance systems, report generation, and two-dimensional arrays where data is organized in rows and columns.",

  realWorldUsageTamil:
    "Developers Tables, Matrices, Attendance Systems, Report Generation, Seating Arrangement மற்றும் Two-Dimensional Arrays போன்ற Row மற்றும் Column வடிவில் உள்ள தரவுகளை செயலாக்க Nested Loop-ஐ பயன்படுத்துகின்றனர்.",
  ...
  syntaxExplanationEnglish: [
    ...
    "After the inner loop finishes, the outer loop moves to the next iteration.",
    "Nested Loops are commonly used to process rows and columns."
  ],

  syntaxExplanationTamil: [
    "Outer Loop முதலில் இயங்குகிறது.",
    "Outer Loop ஒவ்வொரு முறையும் இயங்கும்போது Inner Loop முழுமையாக இயங்குகிறது.",
    "Inner Loop முடிந்த பிறகே Outer Loop அடுத்த Iteration-க்கு செல்கிறது.",
    "Row மற்றும் Column வடிவில் உள்ள தரவுகளை செயலாக்க Nested Loop பயன்படுத்தப்படுகிறது."
  ],
  ...
  programExplanationEnglish: [
    "Line 1: Creates a class named Main.",
    "Line 3: Program execution starts from the main() method.",
    "Line 5: The outer loop starts and represents students.",
    "Line 7: Displays the current student number.",
    "Line 9: The inner loop starts and represents attendance for each day.",
    "Line 11: Displays the attendance for the current day.",
    "The inner loop executes five times for every student.",
    "After completing all five days, the outer loop moves to the next student.",
    "The process repeats until all students are processed."
  ],

  programExplanationTamil: [
    "வரி 1: Main என்ற பெயரில் ஒரு Class உருவாக்கப்படுகிறது.",
    "வரி 3: Java Program main() Method-இல் இருந்து இயங்கத் தொடங்குகிறது.",
    "வரி 5: Outer Loop மாணவர்களை (Students) குறிக்கிறது.",
    "வரி 7: தற்போதைய மாணவரின் எண் Console-ல் காட்டப்படுகிறது.",
    "வரி 9: Inner Loop ஒவ்வொரு மாணவரின் 5 நாட்கள் Attendance-ஐ குறிக்கிறது.",
    "வரி 11: அந்த நாளின் Attendance Console-ல் காட்டப்படுகிறது.",
    "ஒவ்வொரு மாணவருக்கும் Inner Loop 5 முறை இயங்குகிறது.",
    "5 நாட்களும் முடிந்த பிறகு Outer Loop அடுத்த மாணவருக்கு செல்கிறது.",
    "அனைத்து மாணவர்களும் முடியும் வரை இந்த செயல்முறை தொடர்கிறது."
  ],
